...
Previously RSE at **Stanford University** ([METER-AI / Andrew Ng](https://meter-ai.web.app/team), Doerr School of Sustainability, SRCC), where I architected cloud data pipelines processing 14M+ records from 200+ sources and led the open-sourcing of a methane emissions dataset now used by [Planet](https://www.planet.com/) and [CarbonMapper](https://carbonmapper.org/) for climate mitigation. Before that, nearly three years at **UW-Madison Radiology** building serverless containerized tools for neuroimaging data management (BIDS, NIfTI, DICOM, Flywheel.io) and GB-range deidentification pipelines under HIPAA/IRB compliance.

Currently exploring **open neuroscience infrastructure** — studying how platforms like [brainlife.io](https://brainlife.io) and [FreeSurfer](https://surfer.nmr.mgh.harvard.edu/) are architected, and how standards like BIDS and NWB govern the flow of data from scanner to archive.
...
- [**MassGen1**](https://github.com/mfeldman143) — Framework for AI-augmented workflows
